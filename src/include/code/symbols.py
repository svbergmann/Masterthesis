...
sigma_tilde_lambda_w = Symbol('\\tilde{\sigma}_{\lambda_w}')
sigma_tilde_w = Symbol('\\tilde{\sigma}_w')
sigma_lambda_w = Symbol('\sigma_{\lambda_w}')
sigma_lambda_theta_l = Symbol('\sigma_{\lambda\\theta_l}')
sigma_lambda_r_t = Symbol('\sigma_{{\lambda}r_t}')
...
r_t_bar, r_t_prime_2_bar = symbols(
    '\overline{r_t} \overline{r_t\'^2}'
)
...
theta_l_prime_r_t_prime_bar = Symbol('\overline{\\theta_l\'r_t\'}')
...
sk_hat_w = Symbol('\widehat{Sk}_w')
sk_theta_l_hat = Symbol('\widehat{Sk}_{\\theta_l}')
c_w_theta_l_hat = Symbol('\hat{c}_{w\\theta_l}')
G_3 = Symbol('G_3')
