\section{Solving for pdf parameters by using the moment terms}\label{sec:pdfparams}
...
that produces a distribution with moments matching the prognosed values.
...
The proposed solution procedure\footcite{larson2005using} is as follows.
\begin{enumerate}
