...
The second order moment -- $\wptwo$ -- is given as:
\begin{align}
    \label{eq:wp2_bar}
    \wptwo
...
Since we want to make use of the specific shape of the \gls{pdf}, we also have a relationship for $w'^3$, which is called $\widehat{Sk}_w$, meaning the skewness of the variable $w$:
\begin{align}
    \widehat{Sk}_w
